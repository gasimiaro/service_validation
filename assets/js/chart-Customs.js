...
if(jQuery('#chartdiv').length){
    ...
    // Am Charts 
     ...
     if(jQuery('#high-basicline-chart').length){
        ...
        title: {
            text: 'Validation des Services Precaires, 2023-Nos Jours'
        },
    ...
    if(jQuery('#high-pie-chart').length){
        ...
        colorAxis: {},
        title: {
            text: 'Demande chaque type de Budget depuis Janvier, 2023'
        },
        tooltip: {
        ...
        series: [{
            name: 'Taux de demande',
            colorByPoint: true,
            data: [{
                name: 'Budget Generale',
                y: numberBGPerYearData,
                sliced: true,
                selected: true,
                color: '#ff4545'
            }, {
                name: 'Budget Autonome',
                y: numberBAPerYearData,
                color: '#1ee2ac'
            },  {
                name: 'Budget Autonome-Generale',
                y: numberBAGPerYearData,
                color: '#374948'
            }]
        }]
    });
...
if (jQuery("#progress-chart-2").length) {
  var options = {
    series: [ {
      name: 'Validation des services precaire',
      data: numberPerMonthData.map(item => item.nombre)
    }],
    chart: {
      type: 'bar',
      height: 350
    ...
    xaxis: {
      categories: numberPerMonthData.map(item => item.mois),
      labels: {
        minHeight: 30,
        maxHeight: 20
      },
