...
<html lang="en">
   <head>
      ...
      <!-- Typography CSS -->
      <link rel="stylesheet" href="<?php echo base_url()?>assets/template/css/typography.css">
      <!-- Style CSS -->
   ...
   <body class="sidebar-main-active right-column-fixed">
                     ...
                     <li class="active active-menu">
                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active active-menu">
                              ...
                              <ul id="wizard-form" class="iq-submenu collapse show" data-parent="#ui-elements">
      ...
      <script src="<?php echo base_url()?>assets/template/js/apexcharts.js"></script>
      <!-- Slick JavaScript -->
      ...
      <script src="<?php echo base_url()?>assets/template/js/chart-custom.js"></script>
      <!-- music js -->
      <script src="<?php echo base_url()?>assets/template/js/music-player.js"></script>
      <!-- music-player js -->
      <script src="<?php echo base_url()?>assets/template/js/music-player-dashboard.js"></script>
      <!-- Custom JavaScript -->
