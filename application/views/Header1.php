...
<style>
    ...
    .modal-confirm .icon-boxe .fa-check {
        color: green;
        font-size: 46px;
        display: inline-block;
        margin-top: 13px;
  ...
  <body>
    ...
    <div id="loading">
        <div id="loading-center">
          <img src="<?php echo base_url()?>assets/template/images/Logo_hd_MEF-PETIT-2" alt="" srcset="">
        </div>
    </div>
    <!-- loader END -->
    <!-- Wrapper Start -->
          ...
          <div id="sidebar-scrollbar">
              <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li class="">
                      <a href="#admin" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="las la-home iq-arrow-left"></i><span>Acceuil</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                      <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                          <li class=""><a href="<?php echo base_url(); ?>index.php/backend/UserPageHome"><i class="las la-house-damage"></i>Dashboard</a></li>
                    ...
                    <div class="iq-navbar-logo d-flex justify-content-between">
                      <a href="index.html" class="header-logo">
                          ...
                          <div class="pt-2 pl-2 logo-title">
                            <span class="text-primary text-uppercase">La Validation des Service Precaires</span>
                          </div>
                      </a>
                    </div>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item nav-icon">
                          <a href="#" class="search-toggle iq-waves-effect text-black rounded">
                            ...
                            <?php } else{ ?>
                              <span class="notice-icon dots badge badge-info"><?php echo $number; ?></span>
                            <?php } ?>
                          </a>
                                  ...
                                  <a href="#" class="iq-sub-card" id="Viewed">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body ml-3">
                                            ...
                                            <input type="text" name="immatricule" id="immatricule" value="<?php echo $immatricule; ?>">
                                        </div>
                                    </div>
                                  </a>
                                  <script>
                            ...
                            <div class="iq-card shadow-none m-0">
                                <div class="iq-card-body p-0 ">
                                  ...
                                  <div class="d-inline-block w-100 text-center p-3">
                                      <a class="bg-primary iq-sign-btn" href="<?php echo site_url('backend/logout'); ?>" role="button">Deconnexion<i class="ri-login-box-line ml-2"></i></a>
                                  </div>
                                </div>
                            </div>
                          </div>
