          ...
          <div id="sidebar-scrollbar">
              <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        <a href="#pagesValidation" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-function-line"></i><span>Liste de Demande</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
